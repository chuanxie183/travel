...
public class User {
    ...
    private int status;  //帐号状态   0--未激活 1--激活
    ...
    public User(String uid, String username, String password, String name, Date birthday, String sex, String telephone, String email, int status, String code) {
        this.uid = uid;
